...
ActiveRecord::Schema.define(version: 2020_08_13_193656) do
  ...
  create_table "collection_pieces", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id"], name: "index_collection_pieces_on_artwork_id"
    t.index ["collection_id", "artwork_id"], name: "index_collection_pieces_on_collection_id_and_artwork_id", unique: true
    t.index ["collection_id"], name: "index_collection_pieces_on_collection_id"
  end
