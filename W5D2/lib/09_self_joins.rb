...
def craiglockhart_and_tollcross
  ...
  JOIN stops stopsa ON stopsa.id=a.stop_id
  JOIN stops stopsb ON stopsb.id = b.stop_id
...
def craiglockhart_to_sighthill
  ...
  JOIN stops stopsa ON stopsa.id=a.stop_id
  JOIN stops stopsb ON stopsb.id=b.stop_id
  JOIN stops stopsd ON stopsd.id=d.stop_id
  WHERE stopsa.name = 'Craiglockhart' AND stopsd.name = 'Sighthill';
  SQL
end
